public class Main_ArrayList {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 5; i++)
            s1.add(i);
        System.out.println("s1 = " + s1 + " | tamanho = " + s1.size()); // s1 = {1,2,3,4,5} | tamanho = 5

        for (int i = 3; i <= 7; i++)
            s2.add(i);
        System.out.println("s2 = " + s2 + " | tamanho = " + s2.size()); // s2 = {3,4,5,6,7} | tamanho = 5

        IntSet s3 = s1.intersection(s2);
        System.out.println("s3 = " + s3 + " | tamanho = " + s3.size()); // s3 = {3,4,5} | tamanho = 3

        IntSet s4 = s2.intersection(s1);
        System.out.println("s4 = " + s4 + " | tamanho = " + s4.size()); // s4 = {3,4,5} | tamanho = 3
